...
const professionalDataService_1 = require("./professionalDataService");
...
describe('ProfessionalDataService', () => {
    ...
    beforeEach(() => {
        ...
        service = new professionalDataService_1.ProfessionalDataService(mockRepo);
    });
    ...
    it('getProfessionalData retourne la donnée professionelle quand elle existe', async () => {
        const addr = new professionalData_1.ProfessionalData(0, "Engineer", "Capgemini", "2300", "CDI", 7, 0, 0);
    ...
    it('createProfessionalData appelle save et retourne la donnée professionelle créée', async () => {
        const input = new professionalData_1.ProfessionalData(0, "Engineer", "Capgemini", "2300", "CDI", 7, 0, 0);
        const { civil_status_id, situation, company, salary, contract, hours_per_day, overtime, paid_overtime } = input;
        const saved = new professionalData_1.ProfessionalData(civil_status_id, situation, company, salary, contract, hours_per_day, overtime, paid_overtime, 0);
    ...
    it('UpdateProfessionalData appelle update et retourne la donnée professionelle supprimer', async () => {
        ...
        const update = new professionalData_1.ProfessionalData(civil_status_id, situation, company, salary, contract, hours_per_day, overtime, paid_overtime, id);
